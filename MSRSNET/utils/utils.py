...
def train_val(
    ...
    # logging.info(f'SET model mode to {mode}!'+f'epoch: {epoch}')
    logging.info('############################################'+f'SET model mode to {mode}!'+f'epoch: {epoch}'+ '############################################')
    ...
    for k in epoch_metrics.keys():
        ...
        #logging记录
        logging.info(f'epoch_{mode}_{str(k)}: {epoch_metrics[k]}')
    metric_collection.reset()
    log_wandb.log({f'epoch_{mode}_loss': epoch_loss,
                   'epoch': epoch})  # log epoch loss
    #logging记录
    logging.info(f'epoch_{mode}_loss: {epoch_loss}')
